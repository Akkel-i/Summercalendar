...
function change_image1() { 
  ...
  if (document.getElementById("luukku1").src == "Kuvat/kansi.jpg"){
...
function change_image2() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku2").src == "Kuvat/kansi.jpg"){
...
function change_image3() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku3").src == "Kuvat/kansi.jpg"){
...
function change_image4() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku4").src == "Kuvat/kansi.jpg"){
...
function change_image5() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku5").src == "Kuvat/kansi.jpg"){
...
function change_image6() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku6").src == "Kuvat/kansi.jpg"){
...
function change_image7() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku7").src == "Kuvat/kansi.jpg"){
...
function change_image8() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku8").src == "Kuvat/kansi.jpg"){
...
function change_image9() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku9").src == "Kuvat/kansi.jpg"){
...
function change_image10() {
  let paivamaaran_tarkistus = tarkista_paiva("2.24.2023"); // pitää olla kk.pv.vuosi

  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku10").src == "Kuvat/kansi.jpg"){
...
function change_image11() {
  let paivamaaran_tarkistus = tarkista_paiva("2.31.2023"); // pitää olla kk.pv.vuosi

  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku11").src == "Kuvat/kansi.jpg"){
...
function change_image12() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku12").src == "Kuvat/kansi.jpg"){
...
function change_image13() {
  ...
  if (paivamaaran_tarkistus == true) {
  if (document.getElementById("luukku13").src == "Kuvat/kansi.jpg"){
